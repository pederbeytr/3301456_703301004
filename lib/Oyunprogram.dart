            ...
            child: SingleChildScrollView(
              child: Column(
                ...
                children: [
                  ...
                  Padding(
                    padding:
                    const EdgeInsets.only(top: 1, left: 75.0, bottom: 10),
                    child: Text(
                      "Oyun / Yazılım",
                      style: TextStyle(
                                ...
                                Row(
                                  children: [
                                    ...
                                    Column(
                                      children: [
                                        Text(
                                          "Riot Games: league of legends GKey",
                                          style: TextStyle(
                                              fontSize: 20,
                                              backgroundColor: Colors.white),
                                        ),
                                ...
                                Row(
                                  children: [
                                    ...
                                    Column(
                                      children: [
                                        Text(
                                          "Microsoft: Windows 11 Pro Serial Key",
                                          style: TextStyle(
                                              fontSize: 20,
                                              backgroundColor: Colors.white),
                                        ),
                                ...
                                Row(
                                  children: [
                                    ...
                                    Column(
                                      children: [
                                        Text(
                                          "Steam: Counter Strike: GO Game Key",
                                          style: TextStyle(
                                              fontSize: 20,
                                              backgroundColor: Colors.white),
                                        ),
                                ...
                                Row(
                                  children: [
                                    ...
                                    Column(
                                      children: [
                                        Text(
                                          "Steam: Rainbow Six Siege Game Key",
                                          style: TextStyle(
                                              fontSize: 20,
                                              backgroundColor: Colors.white),
                                        ),
